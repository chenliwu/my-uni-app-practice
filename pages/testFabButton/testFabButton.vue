<template>
	<view>
		...
		<uni-fab ref="fab" style="width: 100px;height: 200px;" :pattern="pattern" :content="content" :horizontal="horizontal" :vertical="vertical" :direction="direction" @trigger="trigger" />
	</view>
</template>
